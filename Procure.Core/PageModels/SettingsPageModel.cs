    ...
    public partial class SettingsPageModel : ObservableObject
    {
            ...
            IAppHost appHost)
        {
            ...
            ShortcutRows = new ObservableCollection<ShortcutRowViewModel>(
                Procure.Utilities.KeyboardShortcutRegistry.All.Select(d => new ShortcutRowViewModel(d, _keyboardShortcutService, _dispatcher)));
        ...
        public async Task SelectThemeModeAsync(string mode)
        {
            ...
            // Same curtain/fade the sidebar buttons get; the host falls back to a plain switch.
            await _appHost.ApplyThemeAsync(mode);
        }
        ...
        private void OnUpdateServiceStateChanged(object? sender, EventArgs e)
            => _dispatcher.Post(SyncFromUpdateService);
        ...
        public async Task ChangeDatabaseLocationAsync()
        {
            try
            {
                var newDir = await _dialogs.PickFolderAsync();
                ...
                {
                    await _dialogs.DisplayAlertAsync("Can't Use This Folder",
